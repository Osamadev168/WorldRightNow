    ...
    <div className="mainContainerBanner">
      <div className="bannerdiv1">
        ...
        <p className="text2banner">
          ...
          blogs on our website. With our SEO optimisation and targeted traffic,
          your business will get the online exposure it needs to thrive. Contact
          us & Start blogging your way to success now!
        </p>
      </div>
